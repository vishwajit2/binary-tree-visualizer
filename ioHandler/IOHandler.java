...
/**
 * 
 * I/O Handler: this class is responsible for enabling input from file, opening
 * it, parsing it, dealing with i/o exceptions and invalid syntax, interacting
 * with the data model (tree), and eventually closing the file;
 */
...
public class IOHandler {
	...
	/**
	 * Process input file method tree ----> data model inputFile ----> input file to
	 * process
	 */
			...
			try {
				...
				case "INSERT": // Insert operation...
				{
					...
					if (node != null)
						...
						System.err.println("Error in inserting " + studentID);
					break;
				}
				...
				case "DELETE": // delete operation..
				{
					...
					if (node != null)
						...
						System.out.println("Deletion failed:: " + key + " does exist");
					break;
				}
				...
				case "SEARCH": // search operation..
				{
					...
					if (node != null)
						...
						System.out.println("Search failed: " + key + " does not exist in tree");
					break;
				}
				...
				case "MEDIAN": {
					...
					if (node != null)
						...
						System.out.printf("Tree is empty, %s is NIL\n", command);
					break;
				}
				...
				case "PREDECESSOR": {
					...
					if (command.equals("SUCCESSOR")) // check command == successor..
						...
						node = tree.getPredecessor(tree.getRoot());

					if (node != null)
						System.out.printf("%s is: <%s>\n", command, node);
					else
						System.out.printf("%s of %s is NIL\n", command, key);
					break;
				}
				...
				case "INORDER": {
					if (command.equals("PREORDER"))
						tree.preorderTraversal(tree.getRoot()); // Direct calling function..
